...
public class RestControllerErrorAdvice extends ResponseEntityExceptionHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RestControllerErrorAdvice.class);
    ...
    protected ResponseEntity<Object> handleConstraintViolation(
        ...
        return buildErrorResponse(ex, errorResponse, HttpStatus.INTERNAL_SERVER_ERROR, request);
    }
    ...
    public ResponseEntity<Object> handleAllUncaughtException(Exception exception, WebRequest request) {
        ...
        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), "System error");
        return buildErrorResponse(exception, errorResponse, HttpStatus.INTERNAL_SERVER_ERROR, request);
    }

    private ResponseEntity<Object> buildErrorResponse(Exception ex, ErrorResponse errorResponse,
